...
class AuthController extends Controller
{
   ...
   * Registers the user
   * 
   * @return yii\base\View Render|Response
   */
  ...
  /**
   * Carries out user's login through facebook
   * 
   * @param string $code Code for retrieving access token
   * @param string $state Authentication string
   * @return Response
  ...
  /**
   * Gets token for specific user
   * 
   * @param string $code Code for retrieving access token
   * @return string $token Access token
   * @throws NotFoundHttpException
   */
  private function getFbUserToken($code)
  {
    $params = array(
